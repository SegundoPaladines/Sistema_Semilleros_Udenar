...
<div class="container">
    ...
    <div class="gap-2 d-grid d-md-flex justify-content-md-center">
        <a class="btn btn-warning btn-rounded" href="{{route('proyectosA_report')}}" target="_blank">
                ...
                @foreach($proyectos as $p)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-warning btn-rounded" href="{{route('proyectosAI_report', $p->id_proyecto)}}" target="_blank"> <i class="fas fa-download"></i> Generar Reporte </a>
                            @if($p->id !== $user->id)
